...
from apps.iranian_cities.models import Ostan, Shahrestan, Shahr, Bakhsh, Dehestan, Abadi
...
class ShahrAdmin(admin.ModelAdmin):
    list_display = ['name', 'amar_code', 'shahr_type', 'bakhsh', 'shahrestan', 'ostan']
    list_filter = ['ostan']
    search_fields = ['name', 'amar_code', 'shahr_type', 'bakhsh__name', 'shahrestan__name', 'ostan__name']
...
class AbadiAdmin(admin.ModelAdmin):
    list_display = ['name', 'amar_code', 'abadi_type', 'dehestan', 'bakhsh', 'shahrestan', 'ostan']
    list_filter = ['ostan']
    search_fields = ['name', 'amar_code', 'dehestan__name', 'bakhsh__name', 'shahrestan__name', 'ostan__name']
