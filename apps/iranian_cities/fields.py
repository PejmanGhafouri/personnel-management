...
from apps.iranian_cities.models import Ostan, Shahrestan, Bakhsh, Shahr, Dehestan, Abadi
...
class OstanField(models.ForeignKey):
    ...
    def __init__(self, *args, **kwargs):
        defaults = {'to': Ostan, 'on_delete': models.CASCADE}
...
class ShahrestanField(models.ForeignKey):
    ...
    def __init__(self, *args, **kwargs):
        defaults = {'to': Shahrestan, 'on_delete': models.CASCADE}
        defaults.update(kwargs)
        super().__init__(*args, **defaults)
...
class BakhshField(models.ForeignKey):
    ...
    def __init__(self, *args, **kwargs):
        defaults = {'to': Bakhsh, 'on_delete': models.CASCADE}
        defaults.update(kwargs)
        super().__init__(*args, **defaults)
...
class ShahrField(models.ForeignKey):
    ...
    def __init__(self, *args, **kwargs):
        defaults = {'to': Shahr, 'on_delete': models.CASCADE}
        defaults.update(kwargs)
        super().__init__(*args, **defaults)
...
class DehestanField(models.ForeignKey):
    ...
    def __init__(self, *args, **kwargs):
        defaults = {'to': Dehestan, 'on_delete': models.CASCADE}
        defaults.update(kwargs)
        super().__init__(*args, **defaults)
...
class AbadiField(models.ForeignKey):
    ...
    def __init__(self, *args, **kwargs):
        defaults = {'to': Abadi, 'on_delete': models.CASCADE}
        defaults.update(kwargs)
        super().__init__(*args, **defaults)
